...
<div id="container-inside"> <span style="font-size:16px; font-weight:bold"><?php echo PAYMENT_GATEWAY_SETTING;?></span>
  <hr />
  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="form1">
    <table cellpadding="5" cellspacing="2" border="0">
      <thead>
        <tr>
          <th align="left"><?php echo ENABLED;?></th>
          <th align="left"><?php echo GATEWAY;?></th>
          <th align="left"><?php echo PAYMENT_GATEWAY_TITLE;?></th>
          <th align="left"><?php echo ACCOUNT_INFO;?></th>
        </tr>
        <tr>
          <th colspan="4"><hr /></th>
        </tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><strong><?php echo PAYMENT_GATEWAY_MANUAL;?>:</strong></td>
        ...
        <tr>
          ...
          <td colspan="2"><input type="hidden" name="act_sbmt" value="1" />
            <input type="submit" value="<?php echo EMAIL_UPDATE;?>" style="background:#e5f9bb; cursor:pointer; cursor:hand;"/></td>
        </tr>
      </tbody>
    </table>
  </form>
