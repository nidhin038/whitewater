...
if(isset($_GET['id']) && $_GET['id'] != ""){
	...
	if($id){
		$result = mysqli_query($GLOBALS["___mysqli_ston"], "select * from bsi_language where id=".$id);
 ...
 <form action="<?=$_SERVER['PHP_SELF']?>" method="post" id="form1">
  <table cellpadding="5" cellspacing="2" border="0">
   ...
   <tr>
    ...
    <td><input type="submit" value="<?php echo ADD_EDIT_CAR_SUBMIT;?>" name="submitCapacity" style="background:#e5f9bb; cursor:pointer; cursor:hand;"/></td>
   </tr>
  </table>
 </form><br />
  <?php echo NOTE_TEXT;?>.
