...
if(isset($_GET['delid'])){
	...
	$bsiAdminMain->depositDelete(mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_GET['delid']));
...
?> 
 ...
 <div id="container-inside">
        <span style="font-size:16px; font-weight:bold"><?php echo DEPOSIT_AND_PREPAID_UPON_DURATION_LIST;?></span>&nbsp;&nbsp;
    <input type="button" value="<?php echo ADD_NEW_DEPOSITE_SCHEMA;?>" onClick="window.location.href='add_edit_deposit_duration.php?depoid=0'" style="background: #EFEFEF; float:right"/>
<hr />

  <table class="display datatable" border="0">
    <thead>
      <tr>
        <th><?php echo BOOKING_FROM;?></th>
        <th><?php echo BOOKING_TO;?></th>
        <th><?php echo PREPAID_OF_TOTAL_AMOUNT;?></th>
        <th>&nbsp;</th>
      </tr>
    </thead>
    <tbody><?=$result=$bsiCore->getAllDepositDurationRow();?></tbody>
  </table>
